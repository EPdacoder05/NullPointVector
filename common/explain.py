...
REASON_CODES = {
    "URGENCY_FEAR": "Urgent / fear language",
    "IMPERSONATION": "Brand or authority impersonation",
    "BAD_URL": "Suspicious or abused link",
    "SHORT_LINK": "Hidden destination (shortener)",
    "DOMAIN_MISMATCH": "Link domain ≠ sender domain",
    "SENSITIVE_ASK": "Asks for secrets or money",
    "HTML_OBFUSCATION": "Look-alike / digit brand spelling",
    "HOMOGRAPH": "Homograph / look-alike script (e.g. Cyrillic for Latin)",
    "PUNYCODE_IDN": "Punycode / IDN host (xn--…)",
    "SUSPICIOUS_RELAY": "Relay or disposable-style sender domain",
    "CREDIT_LURE": "Credit / score / loan lure",
    "SPF_FAIL": "Email auth (SPF) failed",
    "DKIM_FAIL": "Email auth (DKIM) failed",
    "DMARC_FAIL": "Email auth (DMARC) failed",
    "AUTH_PASS": "Email auth passed",
    "KNOWN_GOOD": "Known-good sender short-circuit",
    "ANOMALY": "Unusual vs recent traffic pattern",
    "CALLBACK_PRESSURE": "Push to call a number",
    "RELATIONSHIP_LURE": "Romance / NSFW lure pattern",
    "BLACKMAIL": "Extortion / blackmail language",
    "SOCIAL_ENGINEERING": "Social-engineering playbook",
    "HAPPY_LURE": "Prize / congrats lure",
    "DISPLAY_NAME_SPOOF": "Display name does not match mailbox domain",
    "MODEL_SCORE": "Model threat score",
    # High-signal additions
    "REPLY_TO_MISMATCH": "Reply-To differs from From",
    "ADVANCE_FEE": "Advance-fee / pay-to-unlock lure",
    "ATTACHMENT_RISK": "Risky attachment type",
    "IMAGE_ONLY": "Image-only body (little text)",
    "LOOKALIKE_DOMAIN": "Sender domain typosquats a brand",
    "TOLL_FREE_CALLBACK": "Toll-free callback number",
    "NEIGHBOR_SPOOF": "Caller ID matches local area code",
    "CAMPAIGN_MATCH": "Matched known threat campaign",
}
